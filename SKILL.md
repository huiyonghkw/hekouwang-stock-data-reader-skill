...
description: >
  ...
  ⚠️ 个股走公众号/头条为主；小红书仅限"中立复盘/算账/名词科普"形态且守合规护栏（不荐股/不预测/零站外导流），别发以资金流·席位为钩子的机构观感版。
allowed-tools:
  - Bash
  - Read
  - Write
...
- 个股内容主走**公众号/头条**；**小红书可发"中立复盘/算账/名词科普"形态**（守合规护栏、零站外导流、别用资金流/席位当钩子），详见 `references/compliance.md`。
